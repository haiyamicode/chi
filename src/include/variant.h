        ...
        inline static constexpr AUTO_REFREF get_alt(V &&v, in_place_index_t<I>)
          AUTO_REFREF_RETURN(get_alt_impl<I>{}(lib::forward<V>(v)))
            ...
            struct base {
                ...
                inline static constexpr AUTO_REFREF get_alt(V&& v) AUTO_REFREF_RETURN(recursive_union::get_alt(
                        data(lib::forward<V>(v)), in_place_index_t<I>{}))
            };

            struct variant {
                template<std::size_t I, typename V>
                inline static constexpr AUTO_REFREF get_alt(V&& v) AUTO_REFREF_RETURN(
                        base::get_alt<I>(lib::forward<V>(v).impl_))
            };
        ...
        namespace visitation {
            ...
            struct base {
                ...
                struct dispatcher {
                    ...
                    struct impl {
                        inline static constexpr DECLTYPE_AUTO dispatch(F f, Vs... vs) DECLTYPE_AUTO_RETURN(lib::invoke(
                                static_cast<F>(f),
                ...
                inline static constexpr AUTO make_dispatch(lib::index_sequence<Is...>) AUTO_RETURN(
                        &dispatcher<Is...>::template impl<F, Vs...>::dispatch)

                template<std::size_t I, typename F, typename... Vs>
                inline static constexpr AUTO make_fdiagonal_impl() AUTO_RETURN(make_dispatch<F, Vs...>(
                        lib::index_sequence<lib::indexed_type<I, Vs>::value...>{}))

                template<typename F, typename... Vs, std::size_t... Is>
                inline static constexpr AUTO make_fdiagonal_impl(
                        lib::index_sequence<Is...>) AUTO_RETURN(make_farray(make_fdiagonal_impl<Is, F, Vs...>()...))
...
#pragma warning(pop)
            ...
            struct alt {
                ...
                inline static constexpr DECLTYPE_AUTO visit_alt_at(std::size_t index,
                                                                   Visitor&& visitor,
                                                                   Vs&& ... vs) DECLTYPE_AUTO_RETURN(base::at(
                        fdiagonal<Visitor&&,
...
#pragma warning(disable : 4100)
                    ...
                    inline constexpr DECLTYPE_AUTO operator()(Visitor&& visitor,
                                                              Values&& ... values) const DECLTYPE_AUTO_RETURN(
...
#pragma warning(pop)
                ...
                template<typename Visitor>
                inline static constexpr AUTO make_value_visitor(Visitor&& visitor) AUTO_RETURN(
                        value_visitor<Visitor>{lib::forward<Visitor>(visitor)})

            public:
                template<typename Visitor, typename... Vs>
                inline static constexpr DECLTYPE_AUTO visit_alt_at(std::size_t index,
                                                                   Visitor&& visitor,
                                                                   Vs&& ... vs) DECLTYPE_AUTO_RETURN(
  ...
  class move_constructor<traits<Ts...>, move_constructible_trait>            \
    ...
    move_constructor &operator=(move_constructor &&) = default;              \
        ...
        MPARK_VARIANT_MOVE_CONSTRUCTOR(
                Trait::TriviallyAvailable,
                move_constructor(move_constructor && that) =
                        default;);
  ...
  class copy_constructor<traits<Ts...>, copy_constructible_trait>            \
    ...
    copy_constructor &operator=(copy_constructor &&) = default;              \
        ...
        MPARK_VARIANT_COPY_CONSTRUCTOR(
                Trait::TriviallyAvailable,
                copy_constructor(
                        const copy_constructor& that) = default;);
