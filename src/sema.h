...
MAKE_ENUM(IntrinsicSymbol, None, Index, IndexMut, IndexMutIterable, CopyFrom, Display, Add, Sized, AllowUnsized, Construct, Unwrap, UnwrapMut, MutIterator, MutIterable, Slice, Eq, Ord)
