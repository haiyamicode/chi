...
MAKE_ENUM(IntrinsicSymbol, None, Index, IndexMut, IndexMutIterable, Copy, NoCopy, Display, Add, Sub, Mul, Div, Rem, Neg, BitAnd, BitOr, BitXor, BitNot, Shl, Shr, Sized, Unsized, Construct, Unwrap, UnwrapMut, Deref, DerefMut, MutIterator, MutIterable, Slice, Eq, Ord, Hash, EnumName, DiscriminatorName, AsTuple, ListInit, KvInit, AllocInit, AnnotateCopy, MemCopy, MemMove, MemDestroy, ReflectDynElem, AtomicLoad, AtomicStore, AtomicCompareExchange, AtomicFetchAdd, AtomicFetchSub)
