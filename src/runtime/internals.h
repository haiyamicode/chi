...
CHI_RT_EXPORT void cx_typeinfo_destroy(TypeInfo *type, void *data);
...
CHI_RT_EXPORT void cx_set_program_args(int32_t argc, char **argv);
...
CHI_RT_EXPORT const char *__cx_default_chi_home(void);
