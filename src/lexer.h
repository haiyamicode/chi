...
MAKE_ENUM(TokenType, END, IDEN, ERROR,
          ...
          KW_FUNC, KW_GOTO, KW_WHILE, KW_IF, KW_PRIVATE, KW_RETURN, KW_SELECT, KW_STATIC, KW_STRUCT,
          KW_TRAIT, KW_SWITCH, KW_TYPEDEF, KW_TYPEOF, KW_NEW, KW_DELETE, KW_THIS, KW_EXTERN,
          KW_INLINE, KW_UNION, KW_TEMPLATE, KW_TRY, KW_IMPORT, KW_AS, KW_SIZEOF,
