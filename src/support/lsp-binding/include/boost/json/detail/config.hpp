...
#if !defined(BOOST_JSON_NO_SSE2) && !defined(BOOST_JSON_USE_SSE2)
...
#else
#if (defined(BOOST_JSON_DYN_LINK) || defined(BOOST_ALL_DYN_LINK)) &&                               \
    !defined(BOOST_JSON_STATIC_LINK)
...
#define BOOST_JSON_INLINE_VARIABLE(name, type)                                                     \
    namespace {                                                                                    \
    constexpr auto &name = ::boost::json::detail::static_const<type>::value;                       \
    }                                                                                              \
