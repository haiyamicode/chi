...
Chi is a C++ programming language compiler/interpreter that compiles its own custom language (`.xc` files) to native executables. The project uses CMake for build configuration and includes LLVM-based code generation.
